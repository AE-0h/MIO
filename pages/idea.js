...
class User {
  constructor(username, bio, profilePic, profileBanner, userAddress) {
...
class UserNFTContract {
  constructor(name, symbol, contractAddress, totalSupply, mintPrice, baseURI) {
    this.name = name;
    this.symbol = symbol;
